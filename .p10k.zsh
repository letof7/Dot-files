# Generated by Powerlevel10k configuration wizard on 2023-02-24 at 22:36 CET.
...
# 12h time, vertical separators, sharp heads, round tails, 2 lines, solid, right frame,
...
() {
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=93
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=201
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=165
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=201
