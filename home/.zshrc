...
export EDITOR='nano'
export BROWSER=opera-gx
export XDG_DEFAULT_WEB_BROWSER=opera-gx.desktop
...
#alias roblox='echo "on ne repond pas a ses parents, on fait ses devoirs quand il le faut, on ne crie pas en disant arretes"'

alias night="bash /home/tof/.config/hypr/scripts/night.sh"
